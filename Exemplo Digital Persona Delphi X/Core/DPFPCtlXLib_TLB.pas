...
// $Rev: 52393 $
// File generated on 09/05/2016 11:07:28 from Type Library described below.
...
// *********************************************************************//
  _IDPFPVerificationControlEvents = dispinterface
    ...
    function OnComplete(const pFeatureSet: IDispatch; const pStatus: IDispatch): HResult; dispid 1;
  end;
...
// *********************************************************************//
  _IDPFPEnrollmentControlEvents = dispinterface
    ...
    function OnDelete(lFingerMask: Integer; const pStatus: IDispatch): HResult; dispid 1;
    function OnEnroll(lFingerMask: Integer; const pTemplate: IDispatch; const pStatus: IDispatch): HResult; dispid 2;
    function OnFingerTouch(const pSerialNumber: WideString; lEnrolledFinger: Integer): HResult; dispid 3;
    function OnFingerRemove(const pSerialNumber: WideString; lEnrolledFinger: Integer): HResult; dispid 4;
    function OnComplete(const pSerialNumber: WideString; lEnrolledFinger: Integer): HResult; dispid 5;
    function OnReaderConnect(const pSerialNumber: WideString; lEnrolledFinger: Integer): HResult; dispid 6;
    function OnReaderDisconnect(const pSerialNumber: WideString; lEnrolledFinger: Integer): HResult; dispid 7;
    function OnSampleQuality(const pSerialNumber: WideString; lEnrolledFinger: Integer; 
                             lSampleQuality: Integer): HResult; dispid 8;
    function OnStartEnroll(const pSerialNumber: WideString; lEnrolledFinger: Integer): HResult; dispid 9;
    function OnCancelEnroll(const pSerialNumber: WideString; lEnrolledFinger: Integer): HResult; dispid 10;
  end;
...
begin
  ...
  TControlData2(CControlData).FirstEventOfs := UIntPtr(@@FOnComplete) - UIntPtr(Self);
end;
...
begin
  ControlData := @CControlData;
  TControlData2(CControlData).FirstEventOfs := UIntPtr(@@FOnDelete) - UIntPtr(Self);
end;
