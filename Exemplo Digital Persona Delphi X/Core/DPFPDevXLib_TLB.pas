...
// $Rev: 52393 $
// File generated on 09/05/2016 11:07:51 from Type Library described below.
...
// *********************************************************************//
  _IDPFPCaptureEvents = dispinterface
    ...
    function OnComplete(const ReaderSerNum: WideString; const pSample: IDispatch): HResult; dispid 1;
    function OnReaderDisconnect(const ReaderSerNum: WideString): HResult; dispid 2;
    function OnReaderConnect(const ReaderSerNum: WideString): HResult; dispid 3;
    function OnFingerTouch(const ReaderSerNum: WideString): HResult; dispid 4;
    function OnFingerGone(const ReaderSerNum: WideString): HResult; dispid 5;
    function OnSampleQuality(const ReaderSerNum: WideString; 
                             CaptureFeedback: DPFPCaptureFeedbackEnum): HResult; dispid 6;
  end;
...
begin
  DefaultInterface.ReaderSerialNumber := pVal;
end;
